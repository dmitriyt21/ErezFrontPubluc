...
@Component({
  ...
  templateUrl: './discount-for-customer.component.html',
  styleUrls: ['./discount-for-customer.component.css',
              '../../activities.component.css',
              '../../../../../styles/collapsible.css']
})
export class DiscountForCustomerComponent implements OnInit {
