...
@Component({
  ...
  templateUrl: './discount-for-customer-history.component.html',
  styleUrls: ['./discount-for-customer-history.component.css',
              '../../../../../../styles/history-collapsible.css']
})
export class DiscountForCustomerHistoryComponent{
