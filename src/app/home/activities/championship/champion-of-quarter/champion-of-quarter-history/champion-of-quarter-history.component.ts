...
@Component({
  ...
  templateUrl: './champion-of-quarter-history.component.html',
  styleUrls: ['./champion-of-quarter-history.component.css' , 
              '../../../../../../styles/history-collapsible.css']
})
export class ChampionOfQuarterHistoryComponent {
